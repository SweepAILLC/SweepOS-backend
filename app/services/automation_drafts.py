...
_AI_SYSTEM = (
    ...
    "(business_description, target_audience), brand "
    "(unique_selling_proposition, personal_story, mission_statement), sales "
    "(sales_framework, sales_tactics), pipeline_priorities, "
