...
_PICKER_SYSTEM = (
    ...
    "- DATA.intelligence.ladder.upsells is the unified upsells/add-ons menu: only ask for an "
    "  upsell or add-on when at least one offer meaningfully fits the client's goals, triggers, "
    "  and contraindications (no fit = drop upsell).\n"
